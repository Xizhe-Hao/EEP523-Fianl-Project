...
public abstract class Hilt_JournalFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_JournalFragment() {
    super();
  }

  Hilt_JournalFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JournalFragment_GeneratedInjector) this.generatedComponent()).injectJournalFragment(UnsafeCasts.<JournalFragment>unsafeCast(this));
    }
  }
